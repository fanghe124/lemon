...
<html lang="en">
  ...
  <body>
    <div id="wrap">&nbsp;
      <div class="container" style="padding: 0px 40px;" id="top">
        <div class="row">
...
<div class="row">
	<div class="col-md-12">
  	...
  	<c:if test="${diskInfo.type == 'txt' || diskInfo.type == 'html'}">
  	  <nav style="width:100%; height: 700px; box-shadow: 0 0 0 2px #ccc inset; padding: 30px 30px; background-color: #F9F9F9;">
				<object src="${ctx}/disk/api/<tags:currentUsername/>?id=${diskInfo.id}" style="width:100%;height:100%;">
					<embed src="${ctx}/disk/api/<tags:currentUsername/>?id=${diskInfo.id}" style="width:100%;height:100%;"></embed>
				</object>  	
      </nav>
  	...
  	<c:if test="${diskInfo.type == 'jpg' || diskInfo.type == 'jpeg' || diskInfo.type == 'png'}">
			<nav style="width:100%; box-shadow: 0 0 0 2px #ccc inset; padding: 30px 30px; background-color: #F9F9F9;">
