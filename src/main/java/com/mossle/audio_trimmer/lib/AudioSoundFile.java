...
/**
 * AudioSoundFile is the parent class of several subclasses that each do a
...
public class AudioSoundFile {
	public interface ProgressListener {
		/**
		 * Will be called by the AudioSoundFile subclass periodically with
	...
	public interface Factory {
		public AudioSoundFile create();

		public String[] getSupportedExtensions();
	}

	static Factory[] sSubclassFactories = new Factory[] {
			AudioAAC.getFactory(), AudioAMR.getFactory(),
			AudioMP3.getFactory(), AudioWAV.getFactory(), };
	...
	/**
	 * Static method to create the appropriate AudioSoundFile subclass given a
	 * filename.
	 *
	 * TODO: make this more modular rather than hardcoding the logic
	 */
	public static AudioSoundFile create(String fileName,
		...
		AudioSoundFile soundFile = factory.create();
